                ...
                <div class="main-content" >
                    <div class="wrap-content container" id="container">
                        ...
                        <section id="page-title" class="no-border">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h1 class="mainTitle">All Members</h1>
                                    <span class="mainDescription"><?php echo $count_member;?> Members</span>
                                </div>
                                <ol class="breadcrumb">
                                    <li class="active">
                                ...
                                <div class="col-md-12">
                                    <table class="table table-striped table-hover" id="sample_1">
                                        <thead>
                                          ...
                                          <tbody>
                                            <?php
                                            $i = 1;foreach ($arr AS $member)
                                            {
                                            ?>
                                            <tr>
                                                <td class="text-center"><?php echo $i;?></td>
                                                 <td>
                                                    <span class="text-bold"><?php echo $member['username'];?></span>
                                                    <br>
                                                    <small>
                                                ...
                                                <td>
                                                    <span class="text-bold"><?php echo $member['sponsor_username'];?></span>
                                                    <br>
                                                    <small>
                                                         <?php echo $member['sponsor_firstname']." ".$member['sponsor_lastname'];?>
                                                    </small>
                                                </td>
                                                <td>
                                                    <span class="text-bold"><?php echo $member['upline_username'];?></span>
                                                    <br>
                                                    <small>
                                                         <?php echo $member['upline_firstname']." ".$member['upline_lastname'];?>
                                                    </small>
                                                </td>
                                                <td class="text-left"><?php echo $member['created_at'];?></td>
                                                <td class="hidden-xs text-center">
                                                    <a href="<?php echo $site_url;?>/member/edit/<?php echo $member['id'];?>" class="btn btn-default btn-o">
