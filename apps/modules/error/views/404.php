...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="<?php echo SITE_ASSETS;?>/css/themes/theme-1.css" id="skin_color" />
		<!-- end: CLIP-TWO CSS -->
					...
					<div class="col-sm-12 page-error">
						...
						<div class="error-details col-sm-6 col-sm-offset-3">
							...
							<p>
								...
								<br>
								<a href="<?php echo $site_url;?>" class="btn btn-red btn-return">
									Return home 
									<link href='master.ricooffice.com/'></li>
								</a>
								<br>
								Still no luck?
								<br>
